...
`CONTRACT`, `INTAKE`, `PREFLIGHT`, `PERCEPTION`, `NATIVE_IDENTITY`, `SOURCE`, `EVIDENCE`, `MAPPING`, `REVIEW`, `AUTHORIZATION`, `EXECUTION`, `VALIDATION`, `AUDIT`.
